...
(function(b, f) {
    ...
    b.jPlayer.keys = function(a) {
        b(document.documentElement).off("keydown.jPlayer");
        a && b(document.documentElement).on("keydown.jPlayer", p)
    };
    b.jPlayer.keys(!0);
    b.jPlayer.prototype = {
        count: 0,
        ...
        options: {
            ...
            repeat: function(a) {
                a.jPlayer.options.loop ?
                    b(this).off(".jPlayerRepeat").on(b.jPlayer.event.ended + ".jPlayer.jPlayerRepeat", function() {
                        b(this).jPlayer("play")
                    }) : b(this).off(".jPlayerRepeat")
            },
            nativeVideoControls: {},
            noFullWindow: {
                msie: /msie [0-6]\./,
        ...
        _init: function() {
            ...
            b.each(b.jPlayer.event, function(c, b) {
                a.options[c] !== f && (a.element.on(b + ".jPlayer", a.options[c]), a.options[c] = f)
            });
        ...
        destroy: function() {
            ...
            b.each(this.css.jq, function(a,
                c) {
                c.length && c.off(".jPlayer")
            });
            this.internal.poster.jq.off(".jPlayer");
            this.internal.video.jq && this.internal.video.jq.off(".jPlayer");
            this._fullscreenRemoveEventListeners();
            this === b.jPlayer.focus && (b.jPlayer.focus = null);
            this.options.emulateHtml && this._destroyHtmlBridge();
            this.element.removeData("jPlayer");
            this.element.off(".jPlayer");
            this.element.empty();
        ...
        _cssSelector: function(a, c) {
            var d = this;
            "string" === typeof c ? b.jPlayer.prototype.options.cssSelector[a] ? (this.css.jq[a] && this.css.jq[a].length && this.css.jq[a].off(".jPlayer"), this.options.cssSelector[a] = c, this.css.cs[a] = this.options.cssSelectorAncestor + " " + c, this.css.jq[a] = c ? b(this.css.cs[a]) : [], this.css.jq[a].length && this.css.jq[a].on("click.jPlayer", function(c) {
                c.preventDefault();
                d[a](c);
                b(this).blur()
        ...
        _updateAutohide: function() {
            ...
            this.css.jq.gui.length && (this.css.jq.gui.stop(!0, !0), clearTimeout(this.internal.autohideId), this.element.off(".jPlayerAutohide"), this.css.jq.gui.off(".jPlayerAutohide"), this.status.nativeVideoControls ? this.css.jq.gui.hide() : this.options.fullWindow && this.options.autohide.full ||
                !this.options.fullWindow && this.options.autohide.restored ? (this.element.on("mousemove.jPlayer.jPlayerAutohide", c), this.css.jq.gui.on("mousemove.jPlayer.jPlayerAutohide", c), this.css.jq.gui.hide()) : this.css.jq.gui.show())
        },
        fullScreen: function() {
        ...
        _emulateHtmlBridge: function() {
            ...
            b.each(b.jPlayer.event, function(c, d) {
                ...
                e && a.element.on(d + ".jPlayer.jPlayerHtml", function() {
